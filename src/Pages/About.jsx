        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              ...
              >
                Muhammad Dhomanhuri Malik Illyas
              </span>
            </h2>
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Saya seorang Engineer berpengalaman di bidang Cyber Security, Cloud, AI, dan Open-source Enterprise. Pernah memimpin tim Deployment & Engineering untuk mengembangkan platform SaaS SOC, mengelola infrastruktur cloud (GCP, AWS, Alibaba), serta mengintegrasikan perangkat jaringan. Terampil dengan Nuxt.js, Express.js, Laravel, Python, serta basis data MySQL dan Redis. Juga berpengalaman merancang arsitektur ISP berbasis Starlink, memastikan keamanan data, dan mengoptimalkan infrastruktur TI.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://secure.ue.internxt.com/sh/file/xVSvPZLwSBiFfq1rfGLdBw/IamMEPGl" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
