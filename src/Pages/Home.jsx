...
const TECH_STACK = ["Software Engineer", "Cyber Security Engineer", "Cloud Engineer"];
const WORDS = ["React", "Javascript", "Node.js", "Tailwind", "Mikrotik", "Juniper", "Cisco", "Fortinet", "Firewall", "Router", "Switch", "Load Balancer", "Proxy", "VPN", "Firewall", "Router", "Switch", "Load Balancer", "Proxy", "VPN"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/dhomanhuri" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/dhomanhuri/" },
  { icon: Instagram, link: "https://www.instagram.com/dhomanhuri/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Setiap baris kode adalah investasi pada keandalan.
                </p>
